...
for index in range(0, len(item)):
    ...
    original_whole_dict.append(test_dict)
    ...
    context = [people + " " + people_relations_1[0] + " " + people_attributes_1[0] + ". " +
               ...
               people_3 + " " + people_relations_1[0] + " " + people_attributes_4[2] + ". " +
               # people_attributes_1[0].capitalize() + " people are " + people_attributes_3[0] + ". " +
               "If someone is not " + people_attributes_3[0] + " then they are not " + people_attributes_1[0] + ". "
               "If someone is " + people_attributes_2[0] + " and " + people_attributes_2[1] + " then they are " +
               people_attributes_2[2] + ". " +
               "If someone is " + people_attributes_4[0] + " and " + people_attributes_4[1] + " then they are " +
               people_attributes_4[3] + ". " +
               # "If someone is " + people_attributes_3[0] + " and " + people_attributes_3[1] + " then they are " +
               # people_attributes_3[3] + ". " +
               "If someone is not " + people_attributes_3[3] + " then they are not " + people_attributes_3[0] + " and not " + people_attributes_3[1]
                + ". " +
               # "All " + people_attributes_2[2] + " people are " + people_attributes_2[3] + ". " +
               "There is no " + people_attributes_2[2] + " people who are not " + people_attributes_2[3] + ". " +
               "All " + people_attributes_3[0] + " people are " + people_attributes_3[1] + ". " +
               "All " + people_attributes_3[3] + " people are " + people_attributes_3[4] + ". " +
               # "All " + people_attributes_4[3] + " people are " + people_attributes_4[4] + "."
               "There is no " + people_attributes_4[3] + " people who are not " + people_attributes_4[4] + "."
               ]
    question0 = people + " " + people_relations_1[0] + " " + people_attributes_3[1] + "."
    label0 = "true"
    QDep0 = "2"
...
input_name = "NonNegationRule-depth-2"
random.shuffle(original_whole_dict)
split_separator = int(len(original_whole_dict) * 0.8)

# parse(original_whole_dict[:split_separator], input_name, "train")
parse(original_whole_dict[split_separator:], input_name, "dev")

# with open('NonNegationRule-depth-1.jsonl', 'w') as f:
#     for index in original_whole_dict:
#         json.dump(index, f, default=set_default)
#         f.write('\n')

final_whole_dict = []
for item in original_whole_dict[split_separator:]:
    for item2 in whole_dict:
        if item['id'] == item2['id']:
            final_whole_dict.append(item2)
            continue

with open('NonNegationRule-logical_equivalence_reparaphrased_depth-2-dev.jsonl', 'w') as f:
    for index in final_whole_dict:
        json.dump(index, f, default=set_default)
        f.write('\n')