...
gtos = amrlib.load_gtos_model("../amrlib/models/model_generate_t5wtense-v0_1_0")
...
df.to_csv("../amrlib/extracted_data_if_then/reclor_if_then_xfm_t5wtense_bleu_list.csv",index = None,encoding = 'utf8')
