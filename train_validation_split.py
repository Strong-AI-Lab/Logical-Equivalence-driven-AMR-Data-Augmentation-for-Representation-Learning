...
dataframe = pd.read_csv("./Synthetic_xfm_t5wtense_le_contra_double_neg_impli_list_filled.csv")
...
training_set.to_csv("./output_result/Synthetic_xfm_t5wtense_le_contra_double_neg_commuta_impli_list_train_filled.csv",index = None,encoding = 'utf8')
validation_set.to_csv("./output_result/Synthetic_xfm_t5wtense_le_contra_double_neg_commuta_impli_list_dev_filled.csv",index = None,encoding = 'utf8')
