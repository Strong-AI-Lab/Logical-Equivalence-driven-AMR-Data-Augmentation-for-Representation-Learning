...
for index in range(0, len(item)):
    ...
    context = [people + " " + people_relations_1[0] + " " + people_attributes_1[0] + ". " +
               ...
               # "If someone is " + people_attributes_2[0] + " then they are " +
               # people_attributes_2[3] + ". " +
               "If someone is not " + people_attributes_2[3] + " then they are not " + people_attributes_2[0] + ". " +
               # "If someone is " + people_attributes_4[0] + " and " + people_attributes_4[1] + " then they are " +
               # people_attributes_4[4] + ". " +
               "If someone is " + people_attributes_4[1] + " and " + people_attributes_4[0] + " then they are " +
               people_attributes_4[4] + ". " +
               "If someone is " + people_attributes_3[1] + " and " + people_attributes_3[0] + " then they are " +
               people_attributes_3[4] + ". "
               ]
    question0 = people + " " + people_relations_1[0] + " " + people_attributes_3[0] + "."
    label0 = True
...
with open('NonNegationRule-logical_equivalence_reparaphrased_depth-1-dev.jsonl', 'w') as f:
