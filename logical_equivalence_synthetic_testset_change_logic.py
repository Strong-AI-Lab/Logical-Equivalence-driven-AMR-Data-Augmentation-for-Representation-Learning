...
def commutative(df_output, id, sub1, verb1, adj1, sub2, verb2, adj2):
    ...
    s4 = sub2 + " " + verb2 + " not " + adj2

    s1_not = sub1 + " " + verb1 + " not " + adj1
    s2_not = sub2 + " " + verb2 + " not " + adj2
    ...
    concat_sen_not = s1_not + " and " + s2_not + "."
    concat_sen2_not = s2_not + " and " + s1_not + "."
    df_output = df_output.append(
        {'ID': id,
         'Sentence1': concat_sen_not,
         'Sentence2': concat_sen2_not,
         'Label': 1,
         'Tag': "Commutative"}, ignore_index=True)
    ...
    #      'Label': 0,
    #      'Tag': "Commutative"}, ignore_index=True)
    concat_sen4 = s1 + " and " + s4 + "."
    df_output = df_output.append(
        {'ID': id,
         'Sentence1': concat_sen,
         'Sentence2': concat_sen4,
         'Label': 0,
         'Tag': "Commutative"}, ignore_index=True)
...
df_output.to_csv("./synthetic_logical_equivalence_sentence_pair_testset_change_logic.csv",index = None,encoding = 'utf8')